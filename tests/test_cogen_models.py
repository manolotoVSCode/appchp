...
def test_mes_instancia():
    m = CoGenMes(
        ...
        kwh_punta_cubierto=Decimal("333333.33"),
        kwh_intermedia_cubierto=Decimal("333333.33"),
        kwh_base_cubierto=Decimal("83333.34"),
        ahorro_energia_mes_mxn=Decimal("983333.33"),
        ...
        ahorro_electricidad_mxn=Decimal("983333.33"),
...
def test_resultado_totales():
    ...
    r = CoGenResultado(
        ...
        ahorro_electricidad_anual_mxn=Decimal("983333.33"),
        ahorro_energia_anual_mxn=Decimal("983333.33"),
        ahorro_capacidad_anual_mxn=Decimal("0"),
        ahorro_distribucion_anual_mxn=Decimal("0"),
